  ...
  'use strict'; function e(e) {
    ...
    constructor(n, o) {
      return new Proxy(this, { set(i, u, l) {
        ...
        l = S(i.$onBeforeSet), d && (l = S(i.$onBeforeUpdate)), r(h.transform) && (l = S(h.transform, [ l, n ])), e(w = h.type) && w.length === 1 && s(w[0]) && !t(l) && (l = h.type[0].$hydrate(l), h.type = Array); const j = p(h, u, l, $, o)
        ...
        return o.strict && !c(h).length || (b && !t(l) && (l = new b(l)), i[u] = l, S(i.$onSet), d && (S(i.$onUpdate), i.$applySubscribers(u, l))), !0
      }, get(e, o) {
